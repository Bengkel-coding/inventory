...
<body class="pace-done px-navbar-fixed">
  ...
  <div class="px-content">
    <ol class="breadcrumb page-breadcrumb">
      ...
      <li>Agenda Pimpinan</li>
      <li class="active">List</li>
    </ol>
            <div class="panel">
              <div class="panel-heading">
                <div class="panel-title"><i class="fa fa-list"></i> List Agenda Pimpinan</div>
              </div>
                  ...
                  <table class="table table-striped table-bordered" id="datatables">
                    ...
                    <tbody>
                      <tr class="odd gradeX">
                        ...
                        <td>8.00</td>
                        <td>13.00</td>
                        <td class="center"><a href="edit-agenda-pimpinan.php"> Rapat Koordinator</a></td>
                        <td class="center">Ruang Besar</td>
                        <td class="center">-</td>
                        <td class="center">ESA</td>
                        <td class="center">Canceled</td>
                        <td class="center">
                          <a href="edit-agenda-pimpinan.php" class="btn btn-success"><i class="fa fa-pencil"></i> / <i class="fa fa-search"></i></a> 
                      ...
                      <tr class="even gradeC">
                        ...
                        <td>9.00</td>
                        <td>12.00</td>
                        <td class="center"><a href="edit-agenda-pimpinan.php">Rapat Internal</a></td>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Calendar Agenda Pimpinan</h4>
          </div>
