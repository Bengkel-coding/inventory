    ...
    <div class="row">
      ...
      <div class="col-md-12 fadeIn animated">
        ...
        <div class="panel panel-info">
          <div class="panel-heading">
            <span class="panel-title"><i class="panel-title-icon fa fa-clipboard"></i>Tampilkan Event Calendar</span>
          </div>
          <form action="list-event-calendar.php" method="post" class="panel-body p-y-1">
      ...
      <div class="col-md-12 fadeIn animated">
        ...
        <div class="panel panel-success">
          <div class="panel-heading">
            <span class="panel-title"><i class="panel-title-icon fa fa-list"></i>Event List</span>
          </div>
      ...
      <div class="col-md-7 fadeIn animated">
        <div class="panel panel-success panel-dark">
          <div class="panel-heading">
            <span class="panel-title"><i class="panel-title-icon fa fa-calendar"></i>Event Calendar</span>
          </div>
