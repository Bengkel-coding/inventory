...
<link rel="stylesheet" type="text/css" href="{{ asset(null) }}backend/assets/css/jquery-ui.css">
  ...
  <!-- jQuery -->
  <script  type="text/javascript" src="{{ asset(null) }}backend/assets/js/jquery.min.js"></script>
